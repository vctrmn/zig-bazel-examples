"""
This module sets up the ZLS toolchain and provides rules for using ZLS and Zig.
"""
...
def _zig_runner_impl(ctx):
    ...
    print("zigtoolchaininfo.zig_cache : ", zigtoolchaininfo.zig_cache)
    print("zigtoolchaininfo.zig_exe_path : ", zigtoolchaininfo.zig_exe_path)
    print("zigtoolchaininfo.zig_lib_path : ", zigtoolchaininfo.zig_lib_path)
...
#     zigtoolchaininfo = ctx.toolchains["@rules_zig//zig:toolchain_type"].zigtoolchaininfo
#     zlsinfo = ctx.toolchains["//third_party/zls:toolchain_type"].zlsinfo
